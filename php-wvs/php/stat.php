...
function main()
{
    ...
    uksort($data, function ($a, $b) {
        $rank = ["domain" => 10, "path" => 9, "site-uv" => 8, "site-pv" => 7, "path-uv" => 6, "path-pv" => 5];
